...
final class Category: Identifiable {
    ...
    var categoryColor: CategoryColor = CategoryColor.STRENGTH
    
    /// Logger for debugging and monitoring category operations.
    @Transient
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.tnt.pulsesplit.default.subsystem", category: "Category")
